        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-blue-primary sm:text-4xl xl:text-5xl font-pj">Layanan Transportasi Terpercaya </h2>
                ...
                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        ...
                        />
                        <h3 className="mt-12 text-xl font-bold text-blue-primary/80 font-pj">Customer Service</h3>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        <FontAwesomeIcon 
                            ...
                            className="text-slate-400 text-6xl"
                        />
                        <h3 className="mt-12 text-xl font-bold text-blue-primary/80 font-pj">Door To Door Service</h3>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        <FontAwesomeIcon 
                            ...
                            className="text-slate-400 text-6xl"
                        />
                        <h3 className="mt-12 text-xl font-bold text-blue-primary/80 font-pj">Ready To Serve</h3>
