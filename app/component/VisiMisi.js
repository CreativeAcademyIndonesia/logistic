...
export default function VisiMisi(){
    return(
        <section className="py-10 bg-gradient-to-t from-blue-primary to-blue-700 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-24">
                    <div className="">
                        <div className="mb-10">
                            <h2 className="text-3xl font-bold leading-tight white sm:text-4xl lg:text-5xl">Visi</h2>
                            <p className="mt-6 text-base text-white/70">Visi kami adalah menjadi penyedia jasa pengurusan transportasi terkemuka yang
                            diandalkan oleh pelanggan kami. Kami bertujuan untuk meningkatkan konektivitas dan
                            efisiensi dalam industri transportasi </p>
                        </div>

                        <div>
                            <h2 className="text-3xl font-bold leading-tight white sm:text-4xl lg:text-5xl">Misi</h2>
                            <ol className="mt-6 text-base text-white/70 list-decimal">
