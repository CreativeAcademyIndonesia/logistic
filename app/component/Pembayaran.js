export default function Pembayaran() {
    return (
        <section className="py-10 bg-white sm:py-16 lg:py-24" id="pembayaran">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Mekanisme Pembayaran</h2>
                ...
                <div className="relative mt-12 lg:mt-20 pb-5">
                    ...
                    <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-1 2">
                        <div>
                            ...
                            <h3 className="mt-6 text-xl font-semibold leading-tight text-black md:mt-10">VIA ATM</h3>
                        ...
                        <div>
                            ...
                            <h3 className="mt-6 text-xl font-semibold leading-tight text-black md:mt-10">VIA MOBILE BANKING</h3>
                            <ol className=' text-base text-gray-600 mt-4'>
                        ...
                        <div>
                            ...
                            <h3 className="mt-6 text-xl font-semibold leading-tight text-black md:mt-10">VIA INTERNET BANKING</h3>
                            <ol className=' text-base text-gray-600 mt-4'>
