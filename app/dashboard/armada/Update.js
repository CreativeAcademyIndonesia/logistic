...
export default function Update ({currentData}){
    ...
    const [noSTNK, setNoSTNK] = useState(currentData.No_STNK);
    ...
    async function handleSubmit(e) {
        ...
        e.preventDefault()
        const res = await fetch (`http://${process.env.NEXT_PUBLIC_MYSQL_HOST}/api/armada/${currentData.Id}`, {
            method : "PATCH", 
            headers : {
                                ...
                                <div className="grid gap-4 mb-4 md:grid-cols-2">
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Nama Pemilik Truck</label>
                                        <input 
                                            type="text" 
                                            id="namaPemilikTruck" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="sopirTruck" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Sopir Truck</label>
                                        <input 
                                            type="text" 
                                            id="sopirTruck" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="dGTruck" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">DG Truck</label>
                                        <input 
                                            type="text" 
                                            id="dGTruck" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="noSTNK" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">No STNK</label>
                                        <input 
                                            type="text" 
                                            id="noSTNK" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="alamatSTNK" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Alamat STNK</label>
                                        <input 
                                            type="text" 
                                            id="alamatSTNK" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">No HP Pemilik Truck</label>
                                        <input 
                                            type="text" 
                                            id="noHPPemilikTruck" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">No HP Sopir Truck</label>
                                        <input 
                                            type="text" 
                                            id="noHPSopirTruck" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Masa Berlaku STNK</label>
                                        <input 
                                            type="date" 
                                            id="masaBerlakuSTNK" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Tanggal PAS Masuk</label>
                                        <input 
                                            type="date" 
                                            id="tanggalPASMasuk" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            ...
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Tanggal PAS Akhir</label>
                                        <input 
                                            type="date" 
                                            id="tanggalPASAkhir" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="status" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Status</label>
                                        <input 
                                            type="text" 
                                            id="status" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
