                            ...
                            <div className="p-4 overflow-y-auto">
                                <div className="grid gap-4 mb-4 ">
                                    <div>
                                        <label 
                                            htmlFor="kotaAsal" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Kota Asal</label>
                                        <input 
                                            type="text" 
                                            id="kotaAsal" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="kotaTujuan" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Kota Tujuan</label>
                                        <input 
                                            type="text" 
                                            id="kotaTujuan" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    ...
                                    <div>
                                        <label 
                                            htmlFor="harga" 
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-start">Harga</label>
                                        <input 
                                            type="number" 
                                            id="harga" 
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
